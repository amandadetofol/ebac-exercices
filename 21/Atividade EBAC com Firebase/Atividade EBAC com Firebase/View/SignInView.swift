...
class SignInView: UIView {
    ...
    private let alradyAnUserButton: UIButton = {
        var button = UIButton()
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setTitle("Alreay an User? SignIn", for: .normal)
    ...
    private func addViewsToMainView(){
        ...
        stackView.addArrangedSubview(alradyAnUserButton)
    }
    ...
    private func setupConstraints(){
        ...
        NSLayoutConstraint.activate([
            ...
            alradyAnUserButton.bottomAnchor.constraint(equalTo: loginButton.bottomAnchor, constant: 150),
            alradyAnUserButton.leadingAnchor.constraint(equalTo: stackView.leadingAnchor, constant: 24),
            alradyAnUserButton.trailingAnchor.constraint(equalTo: stackView.trailingAnchor, constant: -24),
            alradyAnUserButton.heightAnchor.constraint(equalToConstant: 48),
        ])
...
extension SignInView {
    ...
    @objc func didTapUpInsideLoginButton() {
        self.delegate?.handleSignInButtonClick()
    }
    
    @objc func didTapUpInsideAldearyAnUserButton(){
        self.delegate?.handleAlradyAnUserButtonClick()
    }
